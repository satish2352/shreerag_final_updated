              ...
              <div class="form-group-inner login-btn-inner row">
                <div class="col-lg-2">
                  <div class="login-horizental cancel-wp pull-left">
                    <a href="{{ route('add-purchase') }}"><button class="btn btn-sm btn-primary login-submit-cs"
                    ...
                    <tr>
                      ...
                      <td>
                        <div style="display: flex; align-items: center;">
                          <a href="{{route('edit-purchase', base64_encode($data->id))}}"><button data-toggle="tooltip"
