    ...
    @endif -->
                                                        ...
                                                        @foreach ($editData as $key => $editDataNew)
                                                            @if ($key == 0)
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                        <div class="form-group">
                                                                            <label for="Service">Vendor Type: <span
                                                                                    class="text-danger">*</span></label>
                                                                            <select class="form-control mb-2 select2"
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="@if (old('contact_person_name')) {{ old('contact_person_name') }}@else{{ $editDataNew->contact_person_name }} @endif"
                                                                                name="contact_person_name"
                                                                                placeholder="Contact Person Name">
                                                                            @if ($errors->has('contact_person_name'))
                                                                                <span
                                                                                    class="red-text"><?php echo $errors->first('contact_person_name', ':message'); ?></span>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                        <div class="form-group">
                                                                            <label>Contact Person Number<span
                                                                                    class="text-danger">*</span></label>
                                                                            <input type="text" class="form-control"
                                                                                id="contact_person_number"
                                                                                value="@if (old('contact_person_number')) {{ old('contact_person_number') }}@else{{ $editDataNew->contact_person_number }} @endif"
                                                                                name="contact_person_number"
                                                                                placeholder="Contact Person Number">
                                                                            @if ($errors->has('contact_person_number'))
                                                                                <span
                                                                                    class="red-text"><?php echo $errors->first('contact_person_number', ':message'); ?></span>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                        <div class="form-group">
                                                                            <label>Purchase Order Date <span
                                                                                    class="text-danger">*</span></label>
                                                                            <div class="cal-icon">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                                        <div class="form-group">
                                                                            <label>Payment Terms <span
                                                                                    class="text-danger">*</span></label>
                                                                            <input type="text" class="form-control"
                                                                                id="payment_terms"
                                                                                value="@if (old('payment_terms')) {{ old('payment_terms') }}@else{{ $editDataNew->payment_terms }} @endif"
                                                                                name="payment_terms"
                                                                                placeholder="Enter payment terms">
                                                                            @if ($errors->has('payment_terms'))
                                                                                <span
                                                                                    class="red-text"><?php echo $errors->first('payment_terms', ':message'); ?></span>
                                                                            @endif
                                                        ...
                                                        <div class="d-flex justify-content-end">
                                                            <button type="button" name="add"
                                                                ...
                                                                id="add" title="Add" data-repeater-create>
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <label
                                                                                for="transport_dispatch">Transport-Dispatch
                                                                                <span class="text-danger">*</span></label>
                                                                            <textarea class="form-control" name="transport_dispatch">
@if (old('transport_dispatch'))
{{ old('transport_dispatch') }}@else{{ $editDataNew->transport_dispatch }}
@endif
</textarea>
                                                                        </div>

                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <label for="note">Remark <span
                                                                                    class="text-danger">*</span></label>
