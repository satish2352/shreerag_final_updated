                                        ...
                                        <div class="login-horizental cancel-wp pull-left">
                                            <form action="{{ route('add-purchase-order') }}" method="POST">
                                                ...
                                                <input type="hidden" name="business_details_id" id="business_details_id"
                                                    value="{{ $business_details_id }}">
                                                <input type="hidden" name="requistition_id" id="requistition_id"
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="contact_person_name" data-editable="false">Contact Person
                                                    Name</th>
                                                <th data-field="contact_person_number" data-editable="false">Contact Person
                                                    Number</th>
                                        ...
                                        <tbody>
                                            @foreach ($getOutput as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ ucwords($data->po_grand_total_amount) }}</td>
                                                    ...
                                                    <td>
                                                        <div style="display: flex; align-items: center;">
                                                            <a
                                                                href="{{ route('edit-purchase-order', $data->purchase_orders_id) }}"><button
