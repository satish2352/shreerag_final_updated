                                ...
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2">
                                        <div class="login-horizental cancel-wp pull-left">
                                            <a href="{{ route('add-vendor') }}"><button
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <div class="d-flex justify-content-end mb-3">
                                            <div class="col-md-4">
                                                <input type="text" name="search" value="{{ request('search') }}"
                                                    class="form-control" placeholder="Search Vendor">
                                            </div>
                                            <div class="col-md-2 ">
                                    ...
                                    data-toolbar="#toolbar"> --}}
                                        ...
                                        <tbody>
                                            @forelse ($data_output as $vendor_data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex; align-items: center;">
                                                            <a
                                                                href="{{ route('edit-vendor', base64_encode($vendor_data->id)) }}"><button
                                                                    data-toggle="tooltip" title="Edit"
                                                                    class="pd-setting-ed"><i class="fas fa-pen-square"
                                                                        aria-hidden="true"></i></button></a>
                                                            <a href="{{ route('delete-vendor', base64_encode($vendor_data->id)) }}"
                                                                id="saveButton"><button data-toggle="tooltip" title="Trash"
