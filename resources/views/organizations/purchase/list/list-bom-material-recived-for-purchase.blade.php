                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: inline-block; align-items: center;">
                                                            ...
                                                            <a href="{{route('list-purchase-order', base64_encode($data->productionId))}} "><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-check" aria-hidden="true"></i> Accept and Send For Purchase </button></a>
                                                        </div>
                                                    </td>
