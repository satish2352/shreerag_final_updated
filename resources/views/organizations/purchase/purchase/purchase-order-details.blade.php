...
@section('content')
    ...
    <div style="display: flex; align-items: center; gap: 12px; padding-left: 17px; padding-bottom: 130px; margin-top: 20px;">
        ...
        <a href="{{ route('download-po-pdf', ['purchase_order_id' => $purchase_order_id]) }}"
            data-toggle="tooltip" title="Download Purchase Order (PDF)"
            style="padding: 8px 15px; font-size: 16px; border-radius: 3px; border: 1px solid rgba(0, 0, 0, .12); background: #28a745; color: #fff; cursor: pointer; text-decoration: none; display: inline-block;">
