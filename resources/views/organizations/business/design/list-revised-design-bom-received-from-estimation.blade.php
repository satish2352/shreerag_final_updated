                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Revised Design And BOM Received From Estimation</h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <div class="table-responsive">
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        data-cookie="true" data-cookie-id-table="saveId2" data-show-export="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="estimated_amount" data-editable="false">Estimated Amount</th>
                                        ...
                                        <tbody>
                                            @forelse(is_iterable($data_output) ? $data_output : [] as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(!empty($data->design_id) && !empty($data->business_details_id))
                                                            <button type="button" class="btn btn-outline-info btn-sm"
                                                                onclick="openRevisedDesignOwnerBomModal({{ $data->business_details_id }}, {{ $data->design_id }})">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('accept-bom-estimation', base64_encode($data->business_details_id)) }}">
                                                            <button class="accept-btn" data-toggle="tooltip" title="Accept BOM Estimation">Accept</button>
                                                        </a>
                                                        &nbsp;
                                                        <a href="{{ route('edit-reject-estimation-owner-side', base64_encode($data->business_details_id)) }}">
                                                            <button class="reject-btn" data-toggle="tooltip" title="Rejected BOM Estimation">Reject</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="14" class="text-center">No revised designs received from estimation.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
...
{{-- BOM Material Items Modal (owner view-only — revised design from estimation) --}}
@include('organizations.common.bom-material-items-modal', [
    'mode'              => 'view_only',
    'businessId'        => 0,
    'businessDetailsId' => 0,
    'designId'          => 0,
    'bomModalId'        => 'revisedDesignOwnerBomModal',
])

@push('scripts')
<script>
    function openRevisedDesignOwnerBomModal(businessDetailsId, designId) {
        ...
        openBomModal_revisedDesignOwnerBomModal(fetchUrl);
    }
</script>
@endpush
@endsection
