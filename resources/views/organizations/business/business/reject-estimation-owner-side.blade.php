                                    ...
                                    <div class="all-form-element-inner">
                                        <div class="row d-flex justify-content-center form-display-center">
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 ">
                                                <form action="{{ route('rejected-bom-estimation') }}" method="POST"
                                                                ...
                                                                <div class="sparkline12-graph">
                                                                    <div id="pwd-container1">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="3" type="text" class="form-control" id="rejected_remark_by_owner"
                                                                                name="rejected_remark_by_owner" placeholder="Enter Remark" required>{{ old('rejected_remark_by_owner') }}</textarea>
                                                                        </div>
                                                                        <div class="form-group">
