                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                                        ...
                                                        <input type="file" class="form-control" accept="application/pdf" name="design_image" data-maxsize="5242880" data-minsize="10240"> <!-- 5MB -->
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="file" class="form-control" accept=".xls,.xlsx" name="bom_image" data-maxsize="5242880" data-minsize="10240"> <!-- 5MB -->
