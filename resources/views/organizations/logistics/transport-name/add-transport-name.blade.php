        ...
        <div class="sparkline12-list">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <center><h1>Add Transport Name Data</h1></center>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="all-form-element-inner">
                                <form action="{{ route('store-transport-name') }}" method="POST" enctype="multipart/form-data" id="regForm">
                                    @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="login-horizental cancel-wp pull-left">
                                                        <a href="{{ route('list-transport-name') }}" class="btn btn-white" style="margin-bottom:50px">Cancel</a>
