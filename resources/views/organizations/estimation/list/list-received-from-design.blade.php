                                            ...
                                            <td>
                                                <div style="display: inline-block; align-items: center;">
                                                    ...
                                                    <a href="{{ route('edit-estimation', base64_encode($data->business_details_id)) }}"
                                                        onclick="return confirmAccept('{{ route('edit-estimation', base64_encode($data->business_details_id)) }}')"
                                                        class="pd-setting-ed"
                                                        data-toggle="tooltip"
                                                        title="Edit">
                                                        <button><i class="fa fa-check" aria-hidden="true"></i> Edit Estimation </button>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
