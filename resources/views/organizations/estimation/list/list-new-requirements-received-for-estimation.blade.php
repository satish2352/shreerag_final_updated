                                        ...
                                        <tbody>
                                            @foreach ($data_output as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('list-new-requirements-received-for-estimation-business-wise', base64_encode($data['business_id'])) }}">
                                                            <button class="btn btn-sm btn-bg-colour" type="submit">Check
                                                                Details</button>
                                                        </a>
                                                    </td>
                                                </tr>
