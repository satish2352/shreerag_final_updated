                            ...
                            <table style="border-top: 1px solid black; border-right: 1px solid black; ">
                                <thead>
                                    <tr style="border-left: 1px solid black; border-bottom: 1px solid black;">
                                        ...
                                        <th style="border-left: 1px solid black; border-bottom: 1px solid black;"><span style="padding: 5px;">Discount</span></th>
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-left: 1px solid black; ">
                                        ...
                                        <td style="border-left: 1px solid black; border-bottom: 1px solid black;"><span style="padding: 5px;">{{ $detail->discount }}</span></td>
