                    ...
                    <div class="sparkline13-list-new border-page" id="printableArea"
                        ...
                        <div style="border: 1px solid black; width: 100%;">
                            ...
                            <div style="border-bottom: 1px solid black; padding: 10px;">
                                <div style="font-family: 'Play', sans-serif!important; font-size:11px;"><b>Dear Sir, Please
                                        arrange to supply the following Material as per quantity, specification, and
                            ...
                            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                                <thead>
                                    <tr style="bold; font-family: 'Play', sans-serif!important;font-size:14px;">
                                        ...
                                        <th class="pdf-font-size"
                                            style="border: 1px solid black; padding: 5px font-size:12px;;">Discount</th>
                                        <th class="pdf-font-size"
                                            style="border-top: 1px solid black;border-bottom: 1px solid black;border-left: 1px solid black; border-right: 1px solid black;  padding: 5px; text-align: right; font-size:12px;">
                                            Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot style="border: 1px solid black;">
                                    ...
                                    <tr style="bold; font-family: 'Play', sans-serif!important; font-size:12px;">
                                        ...
                                        <td style="border-top: 1px solid black;border-bottom:1px solid black;border-left:1px solid black; border-right:none;padding:5px; text-align:right;"
                                            class="text-right">
                                            <b> {{ $purchaseOrderDetails->sum('amount') * ($purchaseOrder->tax_name / 100) }}
                                            </b>
                                        </td>
