                                                                        ...
                                                                        <select class="form-control select2" id="vendor_id"
                                                                            ...
                                                                            @foreach ($dataOutputVendor as $vendor)
                                                                                <option value="{{ $vendor->id }}"
                                                                                    {{ old('vendor_id', $editDataNew->vendor_id) == $vendor->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                                    <div class="form-group">
                                                                        <label>Tax Type <span
                                                                                class="text-danger">*</span></label>
                                                                        <select class="form-control mb-2" name="tax_type"
                                                                            id="tax_type">
                                                                            <option value=""
                                                        ...
                                                        <table class="table table-bordered" id="dynamicTable">
                                                            ...
                                                            @foreach ($editData as $key => $editDataNew)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select
                                                                            class="form-control part-no mb-2  readonly-select"
                                                                            name="part_item_id_{{ $key }}"
                                                                            id="" style="min-width:150px">
                                                                    ...
                                                                    <td>
                                                                        <select class="form-control process_id mb-2"
                                                                            ...
                                                                            <option value="" default>Select Process
                                                                            </option>
...
@endif
                                                ...
                                                <div class="row">
                                                    <div class="login-horizental cancel-wp d-flex justify-content-center"
                                                        style="margin-bottom:50px;">
                                                        <a href="{{ route('list-returnable-chalan') }}"
                                                            class="btn btn-white me-2">Cancel</a>
                                                        <button class="btn btn-sm btn-bg-colour" type="submit">Update
                                                            Data</button>
                                                    </div>
                                                </div>
                                            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#vendor_id').change(function() {
                ...
                if (vendorId) {
                    const url = '{{ route('get-po-numbers', ':vendorId') }}'.replace(':vendorId',
                    vendorId);
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                response.data.forEach(function(po) {
                                    ...
                                    const isSelected = preselectedPoId == po.id ?
                                        'selected' : '';
                                    console.log(isSelected, "isSelectedisSelected");

                                    poDropdown.append(
                                        `<option value="${po.id}" ${isSelected}>${po.purchase_orders_id}</option>`
                                        );
                                });
                            } else {
