                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="all-form-element-inner">
                                            <div class="row d-flex justify-content-center form-display-center">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                    <form action="{{ route('store-returnable-chalan') }}" method="POST"
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                <div class="form-group">
                                                                    <label for="transport_id">Transport Name
                                                                        (Optional)</label>
                                                                    <select class="form-control mb-2" name="transport_id"
                                                                        id="transport_id">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="customer_po_no" value="{{ old('customer_po_no') }}"
                                                                    name="customer_po_no"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                <label for="plant_id">Plant Name <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" id="plant_id"
                                                                    value="{{ old('plant_id') }}" name="plant_id"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                ...
                                                                <input type="date" class="form-control" id="po_date"
                                                                    value="{{ old('po_date') }}" name="po_date"
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                ...
                                                                <input type="text" class="form-control" id="lr_number"
                                                                    value="{{ old('lr_number') }}" name="lr_number"
                                                                    ...
                                                                    <table class="table table-hover table-white repeater"
                                                                        ...
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="col-sm-2 col-part-item">Product
                                                                                    Name
                                                                                </th>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input
                                                                                        ...
                                                                                        name="addmore[0][amount]" readonly
                                                                                        style="width:120px"
                                                                                        type="text">
                                                                                </td>
                                                                                <td>
