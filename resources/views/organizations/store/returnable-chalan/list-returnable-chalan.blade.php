                                        ...
                                        <div class="d-flex justify-content-end mb-3">
                                            <div class="col-md-4">
                                                <input type="text" name="search" value="{{ request('search') }}"
                                                    class="form-control"
                                                    placeholder="Search Vendor Name / Vehicle Name / PO">
                                            </div>
                                            <div class="col-md-2 ">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($getOutput as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data->purchase_orders_id ? ucwords($data->purchase_orders_id) : 'N/A' }}
                                                    </td>
                                                    <td>
                          ...
                          <a href="{{route('show-returnable-chalan', $data->id)}}"><button
                              data-toggle="tooltip" title="Edit" class="pd-setting-ed">View Details</button></a>
                                                    ...
                                                    <td>
                                                        <div style="display: flex; align-items: center;">
                                                            <a
                                                                href="{{ route('show-returnable-chalan', base64_encode($data->id)) }}">
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('edit-returnable-chalan', base64_encode($data->id)) }}"><button
                                                                data-toggle="tooltip" title="Edit"
                                                                class="pd-setting-ed"><i class="fas fa-pen-square"
                                                                    aria-hidden="true"></i></button></a>

                                                        <a
                                                            href="{{ route('delete-returnable-chalan', base64_encode($data->id)) }} "><button
