            ...
            <div class="sparkline12-list">
                <div class="sparkline12-hd">
                    <div class="main-sparkline12-hd">
                        <center>
                            <h1>Received Product Production Material Data</h1>
                        </center>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-form-element-inner">
                                        <form action="{{ route('update-production', $id) }}" method="POST"
                                                        ...
                                                        <tbody style="overflow: scroll;">
                                                            ...
                                                            @foreach ($dataGroupedById as $key => $items)
                                                                @foreach ($items as $index => $item)
                                                                    <tr
                                                                        @if ($item->material_send_production) class="disabled-row" @endif>
                                                                        <td>
                                                                            <input type="hidden"
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control part-no"
                                                                                ...
                                                                                @if ($item->material_send_production) disabled @endif>
                                                                        ...
                                                                        <td>
                                                                            <input class="form-control val-quantity"
                                                                                name="addmore[{{ $index }}][quantity]"
                                                                                type="text"
                                                                                value="{{ $item->quantity }}"
                                                                                @if ($item->material_send_production) readonly @endif>
                                                                        </td>
                                                                        {{-- <td>
                                                                    <input class="form-control val-unit" name="addmore[{{ $index }}][unit]" type="text" value="{{ $item->unit_name }}" @if ($item->material_send_production) readonly @endif>
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control val-unit"
