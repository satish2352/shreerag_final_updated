                            ...
                            <div class="table-responsive"> 
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                    ...
                                    <tbody>
                                        ...
                                        <td> <a href="{{ route('list-accept-design-business-wise', base64_encode($data->business_id)) }}" ><button class="btn btn-sm btn-bg-colour" type="submit" >View Details</button></a></td>
