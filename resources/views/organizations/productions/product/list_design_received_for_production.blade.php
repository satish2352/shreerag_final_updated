                                        ...
                                        <td> <img class="img-size"
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{route('reject-design-edit', base64_encode($data->productionId))}}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
