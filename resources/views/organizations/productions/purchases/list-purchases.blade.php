                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{route('edit-purchases', base64_encode($data->id))}}"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fas fa-pen-square" aria-hidden="true"></i></button></a>
