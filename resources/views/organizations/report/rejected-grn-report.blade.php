                    ...
                    <div class="sparkline13-list">
                        ...
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <form id="filterForm" method="GET" action="{{ route('rejected-grn-report-ajax') }}" target="_blank">
...
<script>
    ...
    function fetchReport(reset = false) {
        ...
        fetch(`{{ route('rejected-grn-report-ajax') }}?${params.toString()}`)
            .then(res => {
