                    ...
                    <div class="sparkline13-list">
                        ...
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <form id="filterForm" method="GET" action="{{ route('vendor-payment-ajax') }}"
                                    target="_blank">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <label>Status</label>
                                            <select name="grn_status_sanction" class="form-control"
                                                id="grn_status_sanction">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="purchase_orders_id" data-editable="false">Purchase Order No.
                                                </th>
