                        ...
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <form id="filterForm" method="GET"
                                    action="{{ route('list-product-completed-report-ajax') }}">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control select2" name="project_name" id="project_name">
                                                ...
                                                @foreach ($getProjectName as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ request('project_name') == $id ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control select2" name="business_details_id"
                                                ...
                                                @foreach ($getProductName as $id => $name)
                                                    <option value="{{ $id }}"
                                                        {{ request('business_details_id') == $id ? 'selected' : '' }}>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="total_estimation_amount" data-editable="false">Estimated
                                                    Amount</th>
                                                <th data-field="total_completed_quantity" data-editable="false">Actual
                                                    Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody id="reportBody">
