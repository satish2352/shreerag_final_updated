...
@section('content')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" name="vendor_name" id="vendor_name">
                                                ...
                                                @foreach ($getVendorName as $id => $vendor_name)
                                                    <option value="{{ $id }}"
                                                        {{ request('vendor_name') == $id ? 'selected' : '' }}>
                                                        {{ $vendor_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" name="po_status" id="po_status">
                                                ...
                                                <option value="open"
                                                    {{ request('po_status') == 'open' ? 'selected' : '' }}>Open</option>
                                                <option value="partially_received"
                                                    {{ request('po_status') == 'partially_received' ? 'selected' : '' }}>
                                                    Partially Received</option>
                                                <option value="pending_gate_pass"
                                                    {{ request('po_status') == 'pending_gate_pass' ? 'selected' : '' }}>
                                                    Pending Gate Pass</option>
                                            </select>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Sr.No.</th>
                                                <th data-field="latest_update" data-editable="false">Date</th>
    ...
    : '-'
                ...
                `).join('');
                        tbody.innerHTML = rows || '<tr><td colspan="7">No records found.</td></tr>';
