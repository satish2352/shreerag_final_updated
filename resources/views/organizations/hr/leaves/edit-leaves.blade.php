                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="form-select-list">
                                                    ...
                                                    <select class="form-control custom-select-value" name="leave_day" id="leave_day">
                                                        ...
                                                        <option value="half_day" {{ $editData->leave_day == 'half_day' ? 'selected' : '' }}>Half Day</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="login-horizental cancel-wp pull-left">
                                                    <a href="{{ route('list-leaves') }}"><button class="btn btn-white" style="margin-bottom:50px">Cancel</button></a>
