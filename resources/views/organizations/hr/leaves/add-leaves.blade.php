                    ...
                    @endif --}}
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="all-form-element-inner">
                                    <form action="{{ route('store-leaves') }}" method="POST" id="addForm" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                {{-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" id="leave_start_date" name="leave_start_date" placeholder="Enter foundation date">
                                                </div>
                                                 --}}
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="leave_start_date">Start Date:</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="login-horizental cancel-wp pull-left">
                                                            <a href="{{ route('list-leaves') }}" class="btn btn-white" style="margin-bottom:50px">Cancel</a>
