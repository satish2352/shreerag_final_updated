                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="all-form-element-inner">
                                    ...
                                    @endif
                                    <form action="{{ route('update-employees') }}" method="POST"
                                        enctype="multipart/form-data" id="editEmployeeForm" autocomplete="off">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="@if (old('employee_name')) {{ old('employee_name') }}@else{{ $editData->employee_name }} @endif"
                                                    ...
                                                    <select class="form-control" id="organization_id"
                                                        ...
                                                        @foreach ($data as $datas)
                                                            <option value="{{ $datas->id }}"
                                                                @if (old('company_name') == $datas->id || $editData->company_id == $datas->id) selected @endif>
                                                                {{ ucfirst($datas->company_name) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    @if (old('image') || isset($editData))
                                                        <div>
                                                            ...
                                                            <img src="@if (old('image')) {{ old('emp_image') }} @elseif(isset($editData->emp_image)) {{ Config::get('DocumentConstant.EMPLOYEES_VIEW') . $editData->emp_image }} @endif"
                                                    ...
                                                    <div class="sparkline12-graph">
                                                        <div id="pwd-container1">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control example1"
                                                                    required name="password" id="password1"
