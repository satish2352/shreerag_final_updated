                                ...
                                <div class="form-group-inner login-btn-inner row">
                                    <div class="col-lg-2">
                                        <div class="login-horizental cancel-wp pull-left">
                                            <a href="{{ route('add-employees') }}"><button
                                                    class="btn btn-sm btn-primary login-submit-cs" type="submit"
                                                    href="{{ route('add-organizations') }}">Add Employees</button></a>
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($getOutput as $data)
                                                <tr>
                                                    ...
                                                    <td><img style="max-width:250px; max-height:150px;"
                                                            ...
                                                            alt="{{ strip_tags($data['employee_name']) }} Image" /></td>
                                                    <td>
                                                        <div style="display: flex; align-items: center;">
                                                            <a
                                                                href="{{ route('edit-employees', base64_encode($data->emp_id)) }}"><button
                                                                    data-toggle="tooltip" title="Edit"
                                                                    class="pd-setting-ed"><i class="fa fa-pencil-square-o"
                                                                        aria-hidden="true"></i></button></a>
                                                            <a
                                                                href="{{ route('delete-employees', base64_encode($data->emp_id)) }} "><button
