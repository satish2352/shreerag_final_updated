                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    ...
                                                    <a href="{{route('delete-departments', base64_encode($data->id))}} "><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                </div>
                                            </td>
                                           </tr>
                                        @endforeach
