        ...
        <div class="sparkline12-list">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <center><h1>Add Departments Data</h1></center>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="all-form-element-inner">
                                ...
                                @endif
                                <form action="{{ route('update-departments') }}" method="POST" enctype="multipart/form-data" id="editEmployeeForm" autocomplete="off">
                                    @csrf
                                    <div class="form-group-inner">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="text" class="form-control" value="@if (old('department_name')) {{ old('department_name') }}@else{{ $editData->department_name }} @endif" id="department_name" name="department_name" placeholder="Enter departments name">
                                            </div>
