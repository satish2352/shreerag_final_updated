      ...
      <div class="row g-3">
          <div class="col-md-3 col-sm-6">
              <div class="status-card">
                  <div class="status-icon available">{{ $employee_counts['total_leaves'] ?? 0 }}</div>
          ...
          <div class="col-md-3 col-sm-6">
              <div class="status-card">
                  <div class="status-icon available">{{ $employee_counts['available_leaves'] ?? 0 }}</div>
                  <div class="status-text">
          ...
          <div class="col-md-3 col-sm-6">
              <div class="status-card">
                  <div class="status-icon previous">{{ $employee_counts['previous_unused_leaves'] ?? 0 }}</div>
                  <div class="status-text">
          ...
          <div class="col-md-3 col-sm-6">
              <div class="status-card">
                  <div class="status-icon pending">{{ $employee_counts['pending_leaves'] ?? 0 }}</div>
                  <div class="status-text">
        ...
        `;
              ...
              new Chart(ctx, {
                  ...
                  data: {
                      ...
                      datasets: [{
                          data: [
                              Number(leave.total_available_leaves) ||
                              0, // Current + Carry Forward
                              Number(leave.total_leaves_taken) || 0,
                              Number(leave.remaining_leaves) || 0
                          ],
                          backgroundColor: ['#2D4E59', '#33B78C', '#34BAB8'],
