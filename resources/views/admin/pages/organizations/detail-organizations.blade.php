                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mg-b-pro-edt">
                                                                        <span class="input-group-addon"><i
                                                                                ...
                                                                                aria-hidden="true"></i></span>
                                                                        <input type="text" id="founding_date"
                                                                            class="form-control" placeholder="Founding Date"
                                                                            value="{{ $data->founding_date }}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mg-b-pro-edt">
                                                                        <span class="input-group-addon"><i
                                                                                class="fa fa-users"
                                                                                aria-hidden="true"></i></span>
                                                                        <input type="text" id="employee_count"
                                                                            class="form-control"
                                                                            placeholder="Employee Count"
                                                                            value="{{ $data->employee_count }}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="pro-edt-img">
                                                                    <img src="{{ Config::get('DocumentConstant.ORGANIZATION_VIEW') . $data->image }}"
                                                        ...
                                                        <select class="form-control" id="roleSelect">
                                                            ...
                                                            @foreach ($dept as $data)
                                                                <option value="{{ $data->id }}">
                                                                    <a
                                                                        href="{{ route('filter-employees', base64_encode($data->id)) }}">{{ $data->department_name }}</a>
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="table-responsive">
                                                        <table id="table" data-toggle="table" data-pagination="true"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th data-field="">#</th>
                                                                    <th data-field="company_name" data-editable="false">
                                                                        Employee Name</th>
                                                                    <th data-field="email" data-editable="false">Email
                                                                    </th>
                                                                    <!-- <th data-field="password" data-editable="false">Password</th> -->
                                                                    <th data-field="mobile_number" data-editable="false">
                                                                        Mobile Number</th>
                                                                    <th data-field="address" data-editable="false">Address
                                                                    </th>
                                                                    <th data-field="image" data-editable="false">Image
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="fetchedDataContainer">
                                                                @foreach ($employees as $data)
                                                                    <tr>
                                                                        ...
                                                                        <td><img style="max-width:250px; max-height:150px;"
                                                                                src="{{ Config::get('DocumentConstant.EMPLOYEES_VIEW') . $data->emp_image }}"
                        ...
                        try {
                            ...
                            if (Array.isArray(data)) {
                                data.forEach(function(item, index) {
                                    var imageUrl =
                                        "{{ Config::get('DocumentConstant.EMPLOYEES_VIEW') }}" +
                                        item.emp_image;
                                    var newRow = '<tr>' +
                                        '<td>' + (index + 1) + '</td>' +
                                        ...
                                        '<td><img style="max-width:250px; max-height:150px;" src="' +
                                        imageUrl + '" alt="' + item.company_name +
                                        ' Image" /></td>' +
                                        '</tr>';
