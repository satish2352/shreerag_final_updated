                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="all-form-element-inner">
                                    <form action="{{ route('store-organizations') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" id="mobile_number"
                                                        ...
                                                        placeholder="Enter mobile number" maxlength="10" pattern="\d{10}"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="cin_number">CIN No. : <span
                                                            class="text-danger">*</span></label>
                                                    <input type="cin_number" class="form-control" id="cin_number"
                                                        value="{{ old('cin_number') }}" name="cin_number"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="employee_count">Employee Count: <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="address"
                                                        value="{{ old('employee_count') }}" name="employee_count"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="founding_date">Foundation Date: <span
                                                            class="text-danger">*</span></label>
                                                    <input type="date" class="form-control" id="founding_date"
                                                        value="{{ old('founding_date') }}" name="founding_date"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" id="website_link"
                                                        value="{{ old('website_link') }}" name="website_link"
