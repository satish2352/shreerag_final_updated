                ...
                <ul class="metismenu" id="menu1">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.HIGHER_AUTHORITY'))
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            {{-- <li class="{{ $isReportActive ? 'active' : '' }}">
                                ...
                                <ul class="submenu-angle" aria-expanded="{{ $isReportActive ? 'true' : 'false' }}"
                            ...
                            <li
                                class="nav-item {{ request()->is('owner/list-business') || request()->is('owner/edit-business/*') ? 'active' : '' }}">
                                <a href="{{ route('list-business') }}" aria-expanded="false"><i
                                        class="fa fa-briefcase icon-wrap"></i><span
                            ...
                            <li class="nav-item {{ request()->is('owner/list-forwarded-to-design') ? 'active' : '' }}">
                                <a href="{{ route('list-forwarded-to-design') }}" aria-expanded="false"> <i
                                        class="fa fa-paper-plane icon-wrap"></i><span class="mini-click-non">Business
                                        Sent For Design</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('estimationdept/list-new-requirements-received-for-estimation') || request()->is('estimationdept/list-new-requirements-received-for-estimation-business-wise/*') ? 'active' : '' }}">
                                <a href="{{ route('list-new-requirements-received-for-estimation') }}"
                                    aria-expanded="false"> <i class="fa fa-project-diagram icon-wrap"></i><span
                                        class="mini-click-non">Design Dept Sent Design and BOM to Estimation
                                        Dept</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-design-received-estimation') || request()->is('owner/list-design-received-estimation-business-wise/*') ? 'active' : '' }}">

                                <a href="{{ route('list-design-received-estimation') }}" aria-expanded="false"><i
                                        class="fa fa-file-alt icon-wrap"></i><span class="mini-click-non">Design and
                                        BOM
                            ...
                            <li
                                ...
                                <a href="{{ route('list-accept-bom-estimation') }}" aria-expanded="false"><i
                                        ...
                                        class="mini-click-non">Accepted Estimation</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-rejected-bom-estimation') || request()->is('owner/list-rejected-bom-estimation-business-wise/*') ? 'active' : '' }}">
                                <a href="{{ route('list-rejected-bom-estimation') }}" aria-expanded="false"><i
                                        class="fa fa-times-circle icon-wrap"></i><span class="mini-click-non">Rejected
                                        Estimation</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-revised-bom-estimation') || request()->is('owner/list-revised-bom-estimation-business-wise/*') ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item {{ request()->is('owner/list-design-uploaded-owner') || request()->is('owner/list-design-uploaded-owner-business-wise/*') ? 'active' : '' }}">
                                <a href="{{ route('list-design-uploaded-owner') }}" aria-expanded="false"><i
                                        class="fa big-icon fa-upload icon-wrap"></i> <span
                                        class="mini-click-non">Design
                            ...
                            <li class="nav-item {{ request()->is('owner/list-design-correction') ? 'active' : '' }}">
                                <a href="{{ route('list-design-correction') }}" aria-expanded="false"><i
                                        class="fa big-icon fa-edit icon-wrap"></i><span class="mini-click-non">Design
                            ...
                            <li
                                ...
                                <a href="{{ route('material-ask-by-prod-to-store') }}" aria-expanded="false"><i
                                        class="fa fa-warehouse icon-wrap"></i><span class="mini-click-non">Material
                                        Ask By Production To Store</span></a>
                            </li>
                            <li
                                ...
                                <a href="{{ route('material-ask-by-store-to-purchase') }}" aria-expanded="false"><i
                                        class="fa fa-truck-loading icon-wrap"></i><span
                                        class="mini-click-non">Purchase Material Ask By Store To Purchase</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-purchase-orders') || request()->is('owner/list-submit-final-purchase-order/*') || request()->is('owner/list-submit-final-purchase-order-particular-business/*') ? 'active' : '' }}">
                                <a href="{{ route('list-purchase-orders') }}" aria-expanded="false"><i
                                        class="fa fa-file-invoice-dollar icon-wrap"></i><span
                                        class="mini-click-non">Purchase order need to check</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-approved-purchase-orders-owner') || request()->is('owner/list-purchase-order-approved-bussinesswise/*') || request()->is('owner/list-submit-final-purchase-order-particular-business/*') ? 'active' : '' }}">
                                <a href="{{ route('list-approved-purchase-orders-owner') }}" aria-expanded="false"><i
                                        class="fa fa-check icon-wrap"></i><span class="mini-click-non">Purchase Order
                                        Approved</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-rejected-purchase-orders-owner') || request()->is('owner/list-purchase-order-rejected-bussinesswise/*') || request()->is('owner/list-submit-final-purchase-order-particular-business/*') ? 'active' : '' }}">
                                <a href="{{ route('list-rejected-purchase-orders-owner') }}" aria-expanded="false"><i
                                        class="fa fa-times icon-wrap"></i><span class="mini-click-non">Purchase Order
                                        Rejected</span></a>
                            </li>
                            <li
                            ...
                            <li class="nav-item {{ request()->is('owner/list-owner-gatepass') ? 'active' : '' }}">
                                <a href="{{ route('list-owner-gatepass') }}"><i
                                        class="fa big-icon fa-id-badge icon-wrap"></i> <span
                            ...
                            <li class="nav-item {{ request()->is('owner/list-owner-grn') ? 'active' : '' }}">
                                <a href="{{ route('list-owner-grn') }}"><i
                                        class="fa big-icon fa-clipboard-check icon-wrap"></i><span
                                        class="mini-click-non">Material Received for GRN Generate</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->is('owner/list-material-sent-to-store-generated-grn') || request()->is('owner/list-material-sent-to-store-generated-grn-businesswise/*') ? 'active' : '' }}">
                                <a href="{{ route('list-material-sent-to-store-generated-grn') }}"><i
                                        class="fa big-icon fa-truck-loading icon-wrap"></i> <span
                            ...
                            <li
                                ...
                                <a href="{{ route('list-owner-material-recived-from-store') }}"><i
                                        class="fa big-icon fa-box icon-wrap"></i><span class="mini-click-non">Store
                                        Dept Material send to Production Dept</span></a>
                            </li>
                            <li
                            ...
                            <li
                                class="nav-item {{ request()->is('storedept/list-rejected-chalan-updated') || request()->is('owner/list-revised-bom-estimation-business-wise/*') ? 'active' : '' }}">
                                <a href="{{ route('list-rejected-chalan-updated') }}" aria-expanded="false"><i
                                        class="fa big-icon fa-times-circle icon-wrap"></i><span
                            ...
                            <li
                                ...
                                <a href="{{ route('list-po-recived-for-approval-payment') }}"
                                    aria-expanded="false"><i
                                        class="fa big-icon fa-file-invoice-dollar icon-wrap"></i><span
                                        class="mini-click-non">PO Payment Release
                                        Request</span></a>
                            </li>
                            <li
                                ...
                                <a href="{{ route('list-release-approval-payment-by-vendor') }}"
                                    aria-expanded="false"><i
                                        class="fa big-icon fa-hand-holding-usd icon-wrap"></i><span
                                        class="mini-click-non">PO Payment Released to Vendor</span></a>
                            </li>

                            <li class="nav-item {{ request()->is('owner/list-login-history') ? 'active' : '' }}">
                                <a href="{{ route('list-login-history') }}" aria-expanded="false"><i
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.PURCHASE'))
                        ...
                        <li class="{{ Request::is('purchase-report') ? 'active' : '' }}">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="{{ Request::is('list-vendor-through-taken-material') ? 'active' : '' }}"><a
                                        href="{{ route('list-vendor-through-taken-material') }}"
                                        aria-expanded="false"><i class="fa fa-users icon-wrap"></i><span
                                            class="mini-click-non">Vendor Through Taken Material</span></a></li>
                                <li class="{{ Request::is('stock-item') ? 'active' : '' }}"><a
                                        href="{{ route('stock-item') }}"><i class="fa fa-box icon-wrap"></i> <span
                                            class="mini-click-non">Item Stock</span></a></li>
                        ...
                        <li
                            class="nav-item {{ Request::is('purchase/vendor/list-vendor') || request()->is('purchase/vendor/add-vendor') || request()->is('purchase/vendor/edit-vendor/*') ? 'active' : '' }}">
                            <a href="{{ route('list-vendor') }}"> <i class="fa fa-users icon-wrap"></i><span
                                    class="mini-click-non">Vendor List</span></a>
                        </li>

                        <li
                            class="nav-item {{ request()->is('purchase/list-tax') || request()->is('purchase/add-tax') || request()->is('purchase/edit-tax/*') ? 'active' : '' }}">
                            <a class="" href="{{ route('list-tax') }}" aria-expanded="false"><i
                                    class="fa fa-receipt icon-wrap"></i> <span class="mini-click-non">Tax</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('purchase/list-vendor-type') || request()->is('purchase/add-vendor-type') || request()->is('purchase/edit-vendor-type/*') ? 'active' : '' }}">
                            <a class="" href="{{ route('list-vendor-type') }}" aria-expanded="false"><i
                                    class="fa fa-id-badge icon-wrap"></i><span class="mini-click-non">Vendor
                                    Type</span></a>
                        </li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li
                                    ...
                                    <a href="{{ route('list-approved-purchase-orders') }}" aria-expanded="false"> <i
                                            class="fa fa-check-circle icon-wrap"></i> <span
                        ...
                        <li
                            class="nav-item {{ request()->is('purchase/list-submited-po-to-vendor') || request()->is('purchase/list-submited-po-to-vendor-businesswise/*') || request()->is('purchase/check-details-of-po-before-send-vendor/*') ? 'active' : '' }}">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.DESIGNER'))
                        <li class="nav-item {{ request()->is('designdept/dashboard') ? 'active' : '' }}">
                            <a href="{{ route('dashboard') }}"><i class="fa fa-tachometer-alt icon-wrap"
                                    aria-hidden="true"></i> <span class="mini-click-non">Dashboard</span></a>
                        </li>
                        ...
                        <li
                            class="nav-item {{ request()->is('designdept/list-new-requirements-received-for-design') || request()->is('designdept/list-new-requirements-received-for-design-businesswise/*') || request()->is('designdept/add-design-upload/*') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->is('designdept/list-design-upload') || request()->is('owner/list-design-uploaded-owner-business-wise/*') ? 'active' : '' }}">
                            <a class="" href="{{ route('list-design-upload') }}" aria-expanded="false"> <i
                                    class="fa fa-paper-plane icon-wrap"></i> <span class="mini-click-non">Designs Sent
                                    To Estimation</span></a>
                        </li>
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.ESTIMATION'))
                        <ul class="sidebar-menu">
                            ...
                            <li
                                class="nav-item {{ request()->is('owner/list-rejected-bom-estimation') || request()->is('owner/list-rejected-bom-estimation-business-wise/*') || request()->is('estimationdept/edit-revised-bom-material-estimation/*') ? 'active' : '' }}">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.PRODUCTION'))
                        <ul class="sidebar-menu">
                            ...
                            <li
                                class="nav-item {{ request()->is('proddept/list-revislist-material-reciveded-design') || request()->is('proddept/reject-design-edit/*') ? 'active' : '' }}">
                            ...
                            <li
                                class="nav-item {{ request()->is('proddept/list-material-received') || request()->is('proddept/list-final-purchase-order-production/*') || request()->is('proddept/edit-recived-inprocess-production-material/*') || request()->is('proddept/edit-recived-bussinesswise-quantity-tracking/*') ? 'active' : '' }}">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.SECURITY'))
                        ...
                        <li
                            class="nav-item {{ request()->is('securitydept/list-gatepass') || request()->is('securitydept/edit-gatepass/*') || request()->is('securitydept/list-po-details/*') ? 'active' : '' }}">
                            <a class="nav-item" href="{{ route('list-gatepass') }}" aria-expanded="false"> <i
                                    class="fa fa-id-card icon-wrap"></i><span class="mini-click-non">List
                                    Gate
                                    Pass</span></a>
                        </li>
                        <li
                            ...
                            <a class="nav-item" href="{{ route('list-dispatch-final-product-close') }}"
                                aria-expanded="false"> <i class="fa fa-lock icon-wrap"></i> <span
                                    class="mini-click-non">Closed PO List</span></a>
                        </li>
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.QUALITY'))
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li
                                    class="nav-item {{ request()->is('quality/list-grn') || request()->is('quality/add-grn/*') ? 'active' : '' }}">
                                    <a href="{{ route('list-grn') }}"><i class="fa fa-clipboard-list icon-wrap"></i>
                                        <span class="mini-click-non">List GRN</span></a>
                                </li>
                            </ul>
                        </li>
                        <li
                            class="nav-item {{ request()->is('quality/list-material-sent-to-quality') || request()->is('quality/list-material-sent-to-quality-businesswise/*') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->is('storedept/list-rejected-chalan-updated') || request()->is('storedept/list-rejected-chalan-details/*') ? 'active' : '' }}">
                            <a href="{{ route('list-rejected-chalan-updated') }}">
                                <i class="fa fa-ban icon-wrap"></i> <span class="mini-click-non">List Rejected
                                    Chalan</span></a>
                        </li>
                        <li
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.STORE'))
                        ...
                        <li>
                            <a class="has-arrow" href="{{ route('list-unit') }}" aria-expanded="false"><i
                                    class="fa fa-chart-pie icon-wrap"></i> <span class="mini-click-non">Report
                                </span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li class="{{ Request::is('store-item-stock-list') ? 'active' : '' }}"><a
                                        href="{{ route('store-item-stock-list') }}"> <i
                                            class="fa fa-boxes icon-wrap"></i><span class="mini-click-non">Stock
                                            Details</span></a></li>

                                <li class="{{ Request::is('list-consumption-report') ? 'active' : '' }}"><a
                                        href="{{ route('list-consumption-report') }}"><i
                                            class="fa fa-chart-line icon-wrap"></i><span
                                            class="mini-click-non">Product Consumption</span></a></li>

                                <li class="{{ Request::is('stock-daily-report') ? 'active' : '' }}"><a
                                        href="{{ route('stock-daily-report') }}"><i
                                            class="fa fa-chart-line icon-wrap"></i><span class="mini-click-non">Stock
                                            Register</span></a></li>
                        ...
                        <li
                            class="nav-item {{ request()->is('storedept/list-material-received-from-quality-bussinesswise') || request()->is('storedept/list-grn-details-po-tracking/*') ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <a href="{{ route('list-material-received-from-quality-po-tracking') }}">
                                <i class="fa fa-clipboard-list icon-wrap"></i><span class="mini-click-non">Tracking
                                    Material</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('storedept/list-rejected-chalan') || request()->is('storedept/add-rejected-chalan/*') ? 'active' : '' }}">
                            <a href="{{ route('list-rejected-chalan') }}"> <i class="fa fa-ban icon-wrap"></i><span
                                    class="mini-click-non">Create Rejected
                                    Chalan</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('storedept/list-rejected-chalan-updated') || request()->is('storedept/list-rejected-chalan-details/*') ? 'active' : '' }}">
                            <a href="{{ route('list-rejected-chalan-updated') }}"><i
                                    class="fa fa-list-alt icon-wrap"></i> <span class="mini-click-non">List Rejected
                                    Chalan</span></a>
                        </li>

                        <li>
                            <a class="has-arrow" href="{{ route('list-unit') }}" aria-expanded="false"><i
                                    class="fa fa-database icon-wrap"></i><span class="mini-click-non">Master
                                </span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="{{ route('list-unit') }}"><i
                                            class="fa fa-ruler-combined icon-wrap"></i><span
                                            class="mini-click-non">List Unit</span></a>
                                </li>
                                ...
                                <li><a href="{{ route('list-rack') }}"><i class="fa fa-layer-group icon-wrap"></i>
                                        <span class="mini-click-non">List Rack</span></a>
                                </li>
                                <li><a href="{{ route('list-process') }}"><i class="fa fa-industry icon-wrap"></i>
                                        <span class="mini-click-non">List Process</span></a></li>
                                ...
                                <li class="nav-item {{ request()->is('purchase/list-part-item') ? 'active' : '' }}">
                                    <a class="" href="{{ route('list-part-item') }}" aria-expanded="false"><i
                                            class="fa fa-tools icon-wrap"></i><span class="mini-click-non">Part
                                            Item</span></a>
                                </li>
                        ...
                        <li
                            class="nav-item {{ request()->is('storedept/list-inventory-material') || request()->is('storedept/add-product-stock/*') || request()->is('storedept/edit-product-stock/*') ? 'active' : '' }}">
                            <a href="{{ route('list-inventory-material') }}"> <i
                                    class="fa fa-warehouse icon-wrap"></i> <span class="mini-click-non">Inventory
                                    Material List</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('storedept/list-delivery-chalan') || request()->is('storedept/show-delivery-chalan/*') || request()->is('storedept/edit-delivery-chalan/*') ? 'active' : '' }}">
                            <a href="{{ route('list-delivery-chalan') }}"><i class="fa fa-truck icon-wrap"></i><span
                                    class="mini-click-non">Delivery Challan</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('storedept/list-returnable-chalan') || request()->is('storedept/add-returnable-chalan/*') || request()->is('storedept/edit-returnable-chalan/*') || request()->is('storedept/show-returnable-chalan/*') ? 'active' : '' }}">
                            <a href="{{ route('list-returnable-chalan') }}"><i class="fa fa-undo-alt icon-wrap"></i>
                                <span class="mini-click-non">Returnable Challan</span></a>
                        </li>
                        <li
                            class="nav-item {{ Request::is('purchase/vendor/list-vendor') || request()->is('purchase/vendor/add-vendor') || request()->is('purchase/vendor/edit-vendor/*') ? 'active' : '' }}">
                            <a href="{{ route('list-vendor') }}"> <i class="fa fa-users icon-wrap"></i><span
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.FINANCE'))
                        ...
                        <li class="{{ Request::is('list-fianance-report') ? 'active' : '' }}">
                            <a class="has-arrow" href="{{ route('list-fianance-report') }}"
                                aria-expanded="false"><i class="fa fa-chart-line icon-wrap"></i><span
                                    class="mini-click-non">Report</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li class="nav-item {{ Request::is('list-fianance-report') ? 'active' : '' }}"><a
                                        href="{{ route('list-fianance-report') }}"> <i
                                            class="fa fa-list-alt icon-wrap"></i> <span class="mini-click-non">Product
                                            Submitted to Dispatch</span></a></li>
                                <li class="{{ Request::is('list-vendor-payment-report') ? 'active' : '' }}"><a
                                        href="{{ route('list-vendor-payment-report') }}" aria-expanded="false"><i
                                            class="fa fa-users icon-wrap"></i><span class="mini-click-non">PO Payment
                        ...
                        <li
                            class="nav-item {{ request()->is('owner/list-release-approval-payment-by-vendor') ? 'active' : '' }}">
                            <a href="{{ route('list-release-approval-payment-by-vendor') }}"
                                aria-expanded="false"><i class="fa fa-coins icon-wrap"></i><span
                                    class="mini-click-non">PO Payment Release to Vendor
                                    By Fianance</span></a>
                        </li>

                        <li
                            class="nav-item {{ request()->is('financedept/recive-logistics-list') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->is('financedept/list-send-to-dispatch') ? 'active' : '' }}">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.LOGISTICS'))
                        ...
                        <li
                            class="nav-item {{ request()->is('logisticsdept/list-send-to-fianance-by-logistics') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->is('logisticsdept/list-vehicle-type') || request()->is('logisticsdept/add-vehicle-type/*') || request()->is('logisticsdept/edit-vehicle-type/*') ? 'active' : '' }}">
                            <a class="" href="{{ route('list-vehicle-type') }}" aria-expanded="false"><i
                                    class="fa fa-truck-moving icon-wrap"></i><span class="mini-click-non">Vehicle
                                    Type</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('logisticsdept/list-transport-name') || request()->is('logisticsdept/add-transport-name') || request()->is('logisticsdept/edit-transport-name/*') ? 'active' : '' }}">
                            <a class="" href="{{ route('list-transport-name') }}" aria-expanded="false"><i
                                    class="fa fa-shipping-fast icon-wrap"></i><span class="mini-click-non">Transport
                                    Name</span></a>
                        </li>
                    @endif
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.DISPATCH'))
                        ...
                        <li
                            class="nav-item {{ request()->is('dispatchdept/list-final-production-completed-received-from-fianance') || request()->is('dispatchdept/add-dispatch/*') ? 'active' : '' }}">
                    ...
                    @if (session()->get('role_id') == config('constants.ROLE_ID.CMS'))
                        ...
                        <li
                            class="nav-item {{ request()->is('cms/list-product') || request()->is('cms/add-product') || request()->is('cms/show-product') || request()->is('cms/edit-product/*') ? 'active' : '' }}">
                            <a href="{{ route('list-product') }}" aria-expanded="false"> <i
                                    class="fa fa-cubes icon-wrap"></i> <span class="mini-click-non">Product</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('cms/list-services') || request()->is('cms/add-services') || request()->is('cms/show-services') || request()->is('cms/edit-services/*') ? 'active' : '' }}">
                            <a href="{{ route('list-services') }}" aria-expanded="false"> <i
                                    class="fa fa-concierge-bell icon-wrap"></i> <span
                                    class="mini-click-non">Services</span></a>
                        </li>

                        <li
                            class="nav-item {{ request()->is('cms/list-testimonial') || request()->is('cms/add-testimonial') || request()->is('cms/show-testimonial') || request()->is('cms/edit-testimonial/*') ? 'active' : '' }}">
                            <a href="{{ route('list-testimonial') }}" aria-expanded="false"><i
                                    class="fa fa-comment-dots icon-wrap"></i> <span
                                    class="mini-click-non">Testimonial</span></a>
                        </li>

                        <li
                            class="nav-item {{ request()->is('cms/list-director-desk') || request()->is('cms/add-director-desk') || request()->is('cms/show-director-desk') || request()->is('cms/edit-director-desk/*') ? 'active' : '' }}">
                            <a href="{{ route('list-director-desk') }}" aria-expanded="false"><i
                                    class="fa fa-briefcase icon-wrap"></i><span class="mini-click-non">Director
                                    Desk</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('cms/list-vision-mission') || request()->is('cms/add-vision-mission') || request()->is('cms/show-vision-mission') || request()->is('cms/edit-vision-mission/*') ? 'active' : '' }}">
                            <a href="{{ route('list-vision-mission') }}" aria-expanded="false"><i
                                    class="fa fa-bullseye icon-wrap"></i><span class="mini-click-non">Vision
                                    Mission</span></a>
                        </li>
                        <li
                            class="nav-item {{ request()->is('cms/list-team') || request()->is('cms/add-team') || request()->is('cms/show-team') || request()->is('cms/edit-team/*') ? 'active' : '' }}">
                            <a href="{{ route('list-team') }}" aria-expanded="false"><i
                                    class="fa fa-users icon-wrap"></i><span class="mini-click-non">Team</span></a>
                        </li>

                        <li
                            class="nav-item {{ request()->is('cms/list-contactus-form') || request()->is('cms/show-contactus-form') ? 'active' : '' }}">
                            <a href="{{ route('list-contactus-form') }}" aria-expanded="false"><i
                                    class="fa fa-envelope-open-text icon-wrap"></i><span
                                    class="mini-click-non">Contact Us Form </span></a>
                        </li>
                        <!-- </ul>
                    </li>                    -->
                    @endif
