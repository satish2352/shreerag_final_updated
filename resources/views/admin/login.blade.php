...
<body>
    ...
    <div class="container-fluid">
        <div class="row " style="display: flex; justify-content: center; ">
            ...
            <div class="col-md-6 col-md-6 col-sm-6  d-flex justify-content-center"
                style="display: flex;
    justify-content: center;
    align-items: center;">
                <div class="col-md-8 col-md-8 col-sm-8 col-xs-12 ">
                    ...
                    <div class="row footer">
                        <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center ">
                            <p>Copyright &copy; {{ date('Y') }} <a href="https://shreeragengineering.com">Shreerag
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding-right: 0px;">
                <img src="{{ asset('website/assets/img/logo/login.png') }}" class="cover-image img-fluid"
                    alt="">
            </div>
        </div>
