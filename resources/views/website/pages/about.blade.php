    ...
    <section>
                ...
                <div class="container p-5">
                    ...
                    <div class="row">
                        <div class="card director shadow-1">
                            ...
                            @else
                                @foreach ($data_director_desk as $aboutus)
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <img src="{{ asset('website/assets/img/about/doottt.png') }}"
                                                class="pl-10 ml-10" alt="">
                                            <img src="{{ Config::get('DocumentConstant.DIRECTOR_DESK_VIEW') }}{{ $aboutus['image'] }}"
                                                id="ddimg1" class="ddimg1"
                                                style="top:120px; left:60px; position:absolute; " alt="">
                                        </div>
                                        <div class="col-lg-8 col-md-8 col-sm-8 text-break mtopDD p-5">
                                            <h4 class="white ppp" id="texxttt">{{ $aboutus['description'] }}
                                                <span id="dots">...</span>
                                            </h4>
                                            <br>
        ...
        <section class="">
            <div class="container-fluid testmo pt-30">
                <div class="row pt-600 pb-40">
                    ...
                    @else
                        @foreach ($data_output_vision_mission as $aboutus)
                        <div class="row">
                            <div class="col-lg-5 text-center">
                                <div class="">
                                    <h1 class="f-800 p-4">VISION</h1>
                                </div>
                                <img src="{{ Config::get('DocumentConstant.VISION_MISSION_VIEW') }}{{ $aboutus['vision_image'] }}" id="vision_mision"
                                    alt="">
                            </div>
                            <div class="col-lg-6 pt-60 pb-50 vison align-items-center d-flex">
                                <h4 class="clrtext">{{ $aboutus['vision_description'] }}</h4>
                            </div>

                            <div class="col-lg-5 order-md-2 text-center">

                                <img src="{{ Config::get('DocumentConstant.VISION_MISSION_VIEW') }}{{ $aboutus['mission_image'] }}" id="vision_mision"
                                    alt="">
                                <div class="">
                            ...
                            <div class="col-lg-6 pt-30 order-md-1 misn1 ">
                                <h4 class="clrtext">{{ $aboutus['mission_description'] }}
                                </h4>
                            </div>
                        </div>
                        @endforeach
        ...
        <section class="team-area pt-10">
            <div class="container">
                ...
                @else
                    @foreach ($data_output_team as $aboutus)
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ Config::get('DocumentConstant.TEAM_VIEW') }}{{ $aboutus['image'] }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ asset('website/assets/img/team/team2b.png') }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                                <div class="team-detail-3 transition-5" data-overlay="8">
                                    <div class="team-content z-5">
                                        <h5 class="green f-700 fs-19 relative"><a>Shubham</a></h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ asset('website/assets/img/team/team3b.png') }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                                <div class="team-detail-3 transition-5" data-overlay="8">
                                    <div class="team-content z-5">
                                        <h5 class="green f-700 fs-19 relative"><a>Shubham</a></h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ asset('website/assets/img/team/team4b.png') }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                                <div class="team-detail-3 transition-5" data-overlay="8">
                                    <div class="team-content z-5">
                                        <h5 class="green f-700 fs-19 relative"><a>Shubham</a></h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ asset('website/assets/img/team/team5b.png') }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                                <div class="team-detail-3 transition-5" data-overlay="8">
                                    <div class="team-content z-5">
                                        <h5 class="green f-700 fs-19 relative"><a>Shubham</a></h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 ">
                        <div class="each-team-3 team_shadow fix">
                            <div class="image-team-3 relative">
                                <a><img src="{{ asset('website/assets/img/team/team6b.png') }}" class="pt-3 pl-3 pr-3"
                                        alt=""></a>
                                <div class="team-detail-3 transition-5" data-overlay="8">
                                    <div class="team-content z-5">
                                        <h5 class="green f-700 fs-19 relative"><a>Shubham</a></h5>
