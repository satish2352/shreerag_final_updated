...
<section class="mobilefoot pt-10 d-md-block d-lg-none">
    ...
    <!-- JS Files -->
    <script src="{{ asset('website/assets/js/modernizr-3.5.0.min.js')}}"></script>
    ...
    <script src="{{ asset('website/assets/cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js')}}"></script>
    ...
    <script src="{{ asset('website/assets/js/lightslider.min.js')}}"></script>
