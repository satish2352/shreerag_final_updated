    ...
    public function __construct(){
        ...
        public function store(Request $request){
            $rules = [
                ...
                'image' => 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DIRECTOR_DESK_IMAGE_MAX_SIZE").'|min:'.Config::get("AllFileValidation.DIRECTOR_DESK_IMAGE_MIN_SIZE").'',
        ...
        public function update(Request $request){
            ...
            if($request->has('image')) {
                $rules['image'] = 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.DIRECTOR_DESK_IMAGE_MAX_SIZE").'|min:'.Config::get("AllFileValidation.DIRECTOR_DESK_IMAGE_MIN_SIZE");
            }
