...
class LoginController extends Controller
{
    ...
    //         dispatch(new StoreLoginLocation(
    //             $user->id,
    //             $request->latitude,
    //             $request->longitude,
    //             $ipAddress
    ...
    //     // 💨 IMMEDIATE REDIRECT (0.3 seconds)
    //     return redirect($this->redirectBasedOnRole($user->role_id));
    // }
    ...
    //     return match ($roleId) {
    //         2 => '/owner/dashboard',
    //         3 => '/designdept/dashboard',
    //         4 => '/proddept/dashboard',
    //         5 => '/storedept/dashboard',
    //         6 => '/purchase/dashboard',
    //         7 => '/securitydept/dashboard',
    //         8 => '/quality/dashboard',
    //         9 => '/financedept/dashboard',
    //         10 => '/hr/dashboard',
    //         11 => '/logisticsdept/dashboard',
    //         12 => '/dispatchdept/dashboard',
    //         13 => '/cms/dashboard',
