     ...
     public function updateReUploadDesign(Request $request){
        ...
        $rules = [
         ...
         $messages = [
            ...
            'design_image.max' => 'The design file size must not exceed'.Config::get("AllFileValidation.DESIGNS_IMAGE_MAX_SIZE").'KB .',
            'design_image.min' => 'The design file size must not be less than'.Config::get("AllFileValidation.DESIGNS_IMAGE_MIN_SIZE").'KB .',
