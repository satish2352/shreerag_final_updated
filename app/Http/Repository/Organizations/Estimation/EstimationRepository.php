...
//         $estimation_data->design_id = $dataOutputNew->design_id;
...
//           $business_applications = BusinessApplicationProcesses::firstOrNew(['business_details_id' => $dataOutputNew->id]);
...
//             $business_applications->design_id = $designIds[0] ?? null; // Use first element if available
//             // $business_applications->design_status_id = config('constants.DESIGN_DEPARTMENT.DESIGN_SENT_TO_ESTIMATION_DEPT_FIRST_TIME');
//             $business_applications->estimation_id = $productionIds[0] ?? null; // Use first element if available
//             $business_applications->	bom_estimation_send_to_owner = config('constants.ESTIMATION_DEPARTMENT.BOM_ESTIMATION_SEND_TO_OWNER');
//             $business_applications->	off_canvas_status = 28;

//             $business_applications->save();
        

//         // $update_data_admin['current_department'] = config('constants.DESIGN_DEPARTMENT.DESIGN_SENT_TO_PROD_DEPT_FIRST_TIME');
//         $update_data_admin['off_canvas_status'] = 28;
//         $update_data_business['off_canvas_status'] = 28;
