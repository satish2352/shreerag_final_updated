...
class NoticeRepository  {
    ...
    public function departmentWiseNotice(){
     ...
     public function addAll($request){
        try {
            ...
            $finalOutput = Notice::find($last_insert_id); // Assuming $request directly contains the ID
    ...
    public function updateOne($request){
        try {
            $updateOutput = Notice::find($request); // Assuming $request directly contains the ID
