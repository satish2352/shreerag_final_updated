...
class DirectorDeskRepository  {
    ...
    public function getAll(){
     ...
     public function addAll($request){
        try {
            ...
            $finalOutput = DirectorDesk::find($last_insert_id); // Assuming $request directly contains the ID
    ...
    public function updateOne($request){
        try {
            $updateOutput = DirectorDesk::find($request); // Assuming $request directly contains the ID
