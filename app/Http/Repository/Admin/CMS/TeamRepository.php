...
class TeamRepository  {
    ...
    public function getAll(){
     ...
     public function addAll($request){
        try {
            ...
            $finalOutput = Team::find($last_insert_id); // Assuming $request directly contains the ID
    ...
    public function updateOne($request){
        try {
            $updateOutput = Team::find($request); // Assuming $request directly contains the ID
