...
class ProductRepository  {
    ...
    public function getAll(){
        try {
            $data_output = Products::orderBy('updated_at', 'desc')->get();
            return $data_output;
        } catch (\Exception $e) {
            return $e;
        }
     ...
     public function addAll($request){
        try {
            ...
            $finalOutput = Products::find($last_insert_id); // Assuming $request directly contains the ID
    ...
    public function updateAll($request){
        try {
            $return_data = array();
            $dataOutput = Products::find($request->id);
    ...
    public function updateOne($request){
        try {
            $updateOutput = Products::find($request); // Assuming $request directly contains the ID
    ...
    public function deleteById($id){
        try {
            $deleteDataById = Products::find($id);
